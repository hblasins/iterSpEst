    ...
    switch xAxisLocation
        case 'bottom'
            for i = 1:length(xTickVisible)
                hText = text(...
                    ...
                    yFig2DatCurr(yDat2FigAxis(yLimit(1))-0.025)+xDy,...
                    strtrim(xLabel{i}),...
        ...
        case 'top'
            for i = 1:length(xTickVisible)
                hText = text(...
                    xFig2DatCurr(xDat2FigAxis(xTickVisible(i))),...
                    yFig2DatCurr(yDat2FigAxis(yLimit(2))+0.025)+xDy,...
                    strtrim(xLabel{i}),...
                    'HorizontalAlignment','Center',...
                    'Interpreter','latex',...
                    'FontSize', fontSize);
...
if ~isempty(yTickLabel)
    ...
    switch yAxisLocation
        case 'left'
            for i = 1:length(yTickVisible)
                hText = text(...
                    xFig2DatCurr(xDat2FigAxis(xLimit(1))-0.01)+yDx,...
        ...
        case 'right'
            for i = 1:length(yTickVisible)
                hText = text(...
                    xFig2DatCurr(xDat2FigAxis(xLimit(2))+0.01)+yDx,...
                    yFig2DatCurr(yDat2FigAxis(yTickVisible(i))),...
                    strtrim(yLabel{i}),...
