...
for readNoise = [readNoiseMult(1) readNoiseMult(10:end)]
    ...
    cameraExposure = zeros(nChannels,1);

    fprintf('Noise multiplier %.3f, channel: ', readNoise);
    for ch = 1:nChannels
        ...
        scene = sceneAdjustIlluminant(refScene,illuminantEnergy(:,ch),0); 
    ...
    fName = fullfile(iterSpEstRoot,'Data',sprintf('noisyScene_%i.mat',cntr)); 
